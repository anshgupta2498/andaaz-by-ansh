...
export class CarouselComponent implements OnInit {
  ...
  carouselImages:string[] = [
    ...
    'https://images.unsplash.com/photo-1564400143768-2f8ea3f310f3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1094&q=80',
...
decrement(){
  if(this.counter == 0){
    this.counter = this.carouselImages.length
  }
  this.counter--
}
}
